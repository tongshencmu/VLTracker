        ...
        while not valid:
            ...
            try:
                ...
                if 'nlp' in template_anno:
                    nlp_prompt = template_anno['nlp']
                else:
                    sentences = ["A picture of a", 
                                 'A photo of a', 
                                 'An image capturing a', 
                                 'An action shot of a', 
                                 'A snapshot of a',  
                                 'A picture presenting a', 
                                 'A candid shot of a', 
                                 'An image showcasing a',
                                 'A capture featuring a',
                                 'A photo depicting a', 
                                 'A view of a',
                                 'A display of a', 
                                 'A depiction of a']  
                    class_name = meta_obj_test.get('object_class_name')
                    nlp_prompt = random.choice(sentences) + ' ' + class_name
                ...
                print(data['template_images'].shape)

                # check whether data is valid
                valid = data['valid']
            except:
                print(f"Data Error from {data['dataset']} !!!")
                valid = False
