...
def local_env_settings():
    ...
    settings.network_path = '/ocean/projects/ele220002p/tongshen/code/vl_tracking/latest/VLTracker/work_dirs/test/networks'    # Where tracking networks are stored.
    ...
    settings.prj_dir = '/ocean/projects/ele220002p/tongshen/code/vl_tracking/latest/VLTracker/work_dirs'
    settings.result_plot_path = '/ocean/projects/ele220002p/tongshen/code/vl_tracking/latest/VLTracker/work_dirs/test/result_plots'
    settings.results_path = '/ocean/projects/ele220002p/tongshen/code/vl_tracking/latest/VLTracker/work_dirs/test/tracking_results'    # Where to store tracking results
    settings.save_dir = '/ocean/projects/ele220002p/tongshen/code/vl_tracking/latest/VLTracker/work_dirs'
    settings.segmentation_path = '/ocean/projects/ele220002p/tongshen/code/vl_tracking/latest/VLTracker/work_dirs/test/segmentation_results'
