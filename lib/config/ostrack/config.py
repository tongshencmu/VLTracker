...
cfg.TEST.ONLINE_SIZES.LASOT = [1]
cfg.TEST.ONLINE_SIZES.GOT10K_TEST = [1]
cfg.TEST.ONLINE_SIZES.TRACKINGNET = [1]

cfg.TEST.MAX_SCORE_DECAY = edict()
cfg.TEST.MAX_SCORE_DECAY.LASOT = [0.95]
cfg.TEST.MAX_SCORE_DECAY.GOT10K_TEST = [0.95]
cfg.TEST.MAX_SCORE_DECAY.TRACKINGNET = [0.9]
