...
class VisionTransformerCE(VisionTransformer):
    ...
    def forward_features(self, z, x, mask_z=None, mask_x=None,
                         ...
                         return_last_attn=False, text_embed=None
                         ):
        ...
        global_index_t = torch.linspace(0, lens_z - 1 + add_dim, lens_z + add_dim).to(x.device)
...
def _create_vision_transformer(pretrained=False, **kwargs):
    ...
    if pretrained:
        if 'npz' in pretrained:
            ...
            print("Loading pretrained MAE ViT CE done.")
    return model
